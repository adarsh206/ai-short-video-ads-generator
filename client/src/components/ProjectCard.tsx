                    ...
                    !forCommunity && (
                        ...
                        className="absolute right-3 top-3 sm:opacity-0 group-hover:opacity-100 transition flex items-center gap-2">
                            <div className="absolute top-3 right-3">
                                <EllipsisIcon className="ml-auto bg-black/20 rounded-full -1 size-7 cursor-pointer"/>
                            </div>
                            <div className="flex flex-col items-end w-32 text-sm">
                                <ul className={`text-xs ${menuOpen ? 'block' : 'hidden'} verflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 backdrop:blur text-white border
                                    border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}>
                                {
